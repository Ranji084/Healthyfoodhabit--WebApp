      ...
      <div className="p-6">
        <form onSubmit={handleSubmit} className="bg-white rounded-[32px] p-8 shadow-sm border border-slate-50 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input 
                ...
                className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-500 transition"
              />
            </div>
            <div>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-[#2D4A43] text-white font-bold py-4 rounded-2xl shadow-lg flex items-center justify-center gap-2 active:scale-[0.98] transition mt-8"
          >
